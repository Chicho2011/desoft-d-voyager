...
@section('content')
    <div class="page-content">
        ...
        {{-- TODO Mejorar vista de contador de visitas en el dashboard --}}
        <div class="row visit-counter">
            <div class="col-md-4">
                <header class="Titles">
                    <h2 >Contador de Visitas</h2>
                    <div class="Titles-sub">Nuestras visitas</div>
                </header>
                <div class="row">
                    <div class="col-md-6"><p style="font-size: 20px;">Día</p></div>
                    <div class="col-md-6"><p style="font-size: 20px;">{{visitsPerCurrentDay()}}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-6"><p style="font-size: 20px;">Mes</p></div>
                    <div class="col-md-6"><p style="font-size: 20px;">{{visitsPerCurrentMonth()}}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-6"><p style="font-size: 20px;">Año</p></div>
                    <div class="col-md-6"><p style="font-size: 20px;">{{visitsPerCurrentYear()}}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-6"><p style="font-size: 20px;">Total</p></div>
                    <div class="col-md-6"><p style="font-size: 20px;">{{visitsAll()}}</p></div>
                </div>
            </div>
            <div class="col-md-4"><p style="font-size: 20px;"></p></div>
            <div class="col-md-4"><p style="font-size: 20px;"></p></div>
        </div>
    </div>
@stop
